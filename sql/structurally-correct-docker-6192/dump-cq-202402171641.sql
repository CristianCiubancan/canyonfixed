...
CREATE TABLE `ad_log` (
  ...
  `words` varchar(300) NOT NULL DEFAULT '',
...
CREATE TABLE `cq_activity_reward_type` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `metempsychosis` tinyint(3) unsigned NOT NULL,
  `reward_grade` tinyint(3) unsigned NOT NULL,
  `activity_req` smallint(5) unsigned NOT NULL,
  `reward1` int(10) unsigned NOT NULL,
  `reward1_num` int(10) unsigned NOT NULL,
  `reward1_mono` tinyint(3) unsigned NOT NULL,
  `reward2` int(10) unsigned NOT NULL,
  `reward2_num` int(10) unsigned NOT NULL,
  `reward2_mono` tinyint(3) unsigned NOT NULL,
  `reward3` int(10) unsigned NOT NULL,
  `reward3_num` int(10) unsigned NOT NULL,
  `reward3_mono` tinyint(3) unsigned NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `cq_activity_task_type` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `open_lev` int(10) unsigned NOT NULL,
  `close_lev` int(10) unsigned NOT NULL,
  `type` tinyint(3) unsigned NOT NULL,
  `max_num` tinyint(3) unsigned NOT NULL,
...
CREATE TABLE `cq_activity_user_task` (
  ...
  `complete_flag` tinyint(4) NOT NULL,
...
CREATE TABLE `cq_bonus` (
  ...
  `ordernumber` varchar(150) NOT NULL DEFAULT '',
...
CREATE TABLE `cq_changename_backup` (
  ...
  `oldname` varchar(45) NOT NULL DEFAULT '',
  `newname` varchar(45) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_deluser` (
  ...
  `name` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '',
...
CREATE TABLE `cq_deluser_timeout` (
  ...
  `account` varchar(45) NOT NULL DEFAULT 'None',
  `password` varchar(45) NOT NULL DEFAULT 'None',
  ...
  `league_contribution` int(10) unsigned NOT NULL DEFAULT 0,
  `shielded_times` smallint(4) unsigned NOT NULL DEFAULT 0,
  `channel_account` varchar(222) NOT NULL DEFAULT '',
  `award_exp` bigint(10) unsigned NOT NULL DEFAULT 0,
  `award_total_exp` bigint(10) unsigned NOT NULL DEFAULT 0,
  `store_exp` bigint(10) unsigned NOT NULL DEFAULT 0,
  `day_reset_date` int(4) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `cq_dyna_global_data` (
  ...
  `data4` int(4) NOT NULL DEFAULT 0,
  `data5` int(4) NOT NULL DEFAULT 0,
  `datastr0` varchar(105) NOT NULL DEFAULT '',
  `datastr1` varchar(105) NOT NULL DEFAULT '',
  `datastr2` varchar(105) NOT NULL DEFAULT '',
  `datastr3` varchar(105) NOT NULL DEFAULT '',
  `datastr4` varchar(105) NOT NULL DEFAULT '',
  `datastr5` varchar(105) NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=100013 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_dynamap` (
  `id` int(4) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(105) NOT NULL DEFAULT 'undefined',
  `describe_text` varchar(381) NOT NULL DEFAULT '',
...
CREATE TABLE `cq_dynanpc` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=500012 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_globalvariable` (
  ...
  `str` varchar(675) DEFAULT NULL,
  `desc` varchar(675) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_type` (`type`) USING BTREE
...
CREATE TABLE `cq_goods` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=4179 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_inner_strength_player` (
  ...
  `finish_value` tinyint(3) unsigned NOT NULL COMMENT 'must be 100 when complete',
  `status` tinyint(3) unsigned NOT NULL COMMENT '1 means perfect',
  `abolish_num` tinyint(3) unsigned NOT NULL,
  `max_life` int(10) unsigned NOT NULL,
  `physic_attack_new` int(10) unsigned NOT NULL,
  `magic_attack` int(10) unsigned NOT NULL,
  `physic_defense_new` int(10) unsigned NOT NULL,
  `magic_defense` int(10) unsigned NOT NULL,
  `final_physic_add` smallint(5) unsigned NOT NULL,
  `final_magic_add` smallint(5) unsigned NOT NULL,
  `final_physic_reduce` smallint(5) unsigned NOT NULL,
  `final_magic_reduce` smallint(5) unsigned NOT NULL,
  `physic_crit` smallint(5) unsigned NOT NULL,
  `magic_crit` smallint(5) unsigned NOT NULL,
  `defense_crit` smallint(5) unsigned NOT NULL,
  `smash_rate` smallint(5) unsigned NOT NULL,
  `firm_defense_rate` smallint(5) unsigned NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `cq_inner_strength_rand` (
  `inner_strength_no` tinyint(3) unsigned NOT NULL,
  `range_no` tinyint(3) unsigned NOT NULL,
  `range_rate` int(10) unsigned NOT NULL,
  PRIMARY KEY (`inner_strength_no`,`range_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_inner_strength_secret` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `player_id` int(10) unsigned NOT NULL,
  `secret_type` tinyint(3) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_inner_strength_type_info` (
  ...
  `secret_type` tinyint(3) unsigned NOT NULL,
  `abolish_culture` int(10) unsigned NOT NULL,
  `rand_type1` int(10) unsigned NOT NULL,
  `rand_type2` int(10) unsigned NOT NULL,
  `rand_type3` int(10) unsigned NOT NULL,
  `max_life` int(10) unsigned NOT NULL,
  `physic_attack_new` int(10) unsigned NOT NULL,
  `magic_attack` int(10) unsigned NOT NULL,
  `physic_defense_new` int(10) unsigned NOT NULL,
...
CREATE TABLE `cq_inner_strength_type_lev_info` (
  ...
  `type` smallint(5) unsigned NOT NULL,
  `level` tinyint(3) unsigned NOT NULL,
  `culture_value` int(10) unsigned NOT NULL,
  `max_life` int(11) NOT NULL,
  `physic_attack_new` int(11) NOT NULL,
  `magic_attack` int(11) NOT NULL,
  `physic_defense_new` int(11) NOT NULL,
  `magic_defense` int(11) NOT NULL,
  `final_physic_add` int(11) NOT NULL,
  `final_magic_add` int(11) NOT NULL,
  `final_physic_reduce` int(11) NOT NULL,
  `final_magic_reduce` int(11) NOT NULL,
  `physic_crit` int(11) NOT NULL,
  `magic_crit` int(11) NOT NULL,
  `defense_crit` int(11) NOT NULL,
  `smash_rate` int(11) NOT NULL,
  `firm_defense_rate` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_item` (
  ...
  `chk_sum` int(4) unsigned NOT NULL DEFAULT 0,
  `plunder` int(10) unsigned DEFAULT NULL,
  ...
  `refine_owner_name` varchar(45) NOT NULL DEFAULT '',
  `refine_comment` varchar(96) NOT NULL DEFAULT '',
...
) ENGINE=MyISAM AUTO_INCREMENT=59271 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=14005 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_itemtype` (
  ...
  `type_desc` varchar(150) DEFAULT NULL,
...
CREATE TABLE `cq_jail_log` (
  ...
  `reason` varchar(93) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_jianghu_player` (
  ...
  `gongfu_name` varchar(16) NOT NULL DEFAULT '',
  `power_level` tinyint(3) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `cq_leaveword` (
  ...
  `send_name` varchar(45) NOT NULL DEFAULT 'unknown',
  `time` varchar(45) NOT NULL DEFAULT '00000000000000',
  `words` varchar(765) NOT NULL DEFAULT 'undefined',
...
CREATE TABLE `cq_lottery` (
  ...
  `prize_name` varchar(96) NOT NULL DEFAULT '',
...
) ENGINE=MyISAM AUTO_INCREMENT=618 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_mail` (
  ...
  `Sender_name` varchar(96) NOT NULL DEFAULT '',
...
CREATE TABLE `cq_message_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=1894 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_monster_type_magic` (
  ...
  `magic_type1` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type1` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param1` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time1` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time1` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  `magic_type2` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type2` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param2` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time2` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time2` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  `magic_type3` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type3` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param3` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time3` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time3` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  `magic_type4` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type4` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param4` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time4` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time4` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  `magic_type5` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type5` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param5` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time5` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time5` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  `magic_type6` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type6` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param6` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time6` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time6` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  `magic_type7` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type7` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param7` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time7` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time7` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  `magic_type8` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type8` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param8` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time8` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time8` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  `magic_type9` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type9` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param9` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time9` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time9` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  `magic_type10` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `trigger_type10` smallint(5) unsigned NOT NULL DEFAULT 0,
  `trigger_param10` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `cold_time10` int(10) unsigned zerofill NOT NULL DEFAULT 0000000000,
  `warning_time10` smallint(5) unsigned zerofill NOT NULL DEFAULT 00000,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `cq_monstertype` (
  `id` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
  `name` varchar(105) NOT NULL DEFAULT 'None',
  `type` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
  `lookface` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
  `life` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
...
CREATE TABLE `cq_newaction` (
  ...
  `id_nextfail` int(10) unsigned NOT NULL DEFAULT 0,
  `type` int(10) unsigned NOT NULL DEFAULT 0,
  `data` int(10) unsigned NOT NULL DEFAULT 0,
  `param` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `cq_passway` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `mapid` (`mapid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=172320 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_petpoint` (
  ...
  `ridepet_point` smallint(5) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_pk_bonus` (
  ...
  `Hunter_name` varchar(45) DEFAULT NULL,
...
CREATE TABLE `cq_pk_info` (
  ...
  `pk1_name` varchar(93) NOT NULL DEFAULT '',
  `pk2` int(4) unsigned NOT NULL DEFAULT 0,
  `pk2_name` varchar(93) NOT NULL DEFAULT '',
  `pk3` int(4) unsigned NOT NULL DEFAULT 0,
  `pk3_name` varchar(93) NOT NULL DEFAULT '',
  `pk4` int(4) unsigned NOT NULL DEFAULT 0,
  `pk4_name` varchar(93) NOT NULL DEFAULT '',
  `pk5` int(4) unsigned NOT NULL DEFAULT 0,
  `pk5_name` varchar(93) NOT NULL DEFAULT '',
  `pk6` int(4) unsigned NOT NULL DEFAULT 0,
  `pk6_name` varchar(93) NOT NULL DEFAULT '',
  `pk7` int(4) unsigned NOT NULL DEFAULT 0,
  `pk7_name` varchar(93) NOT NULL DEFAULT '',
  `pk8` int(4) unsigned NOT NULL DEFAULT 0,
  `pk8_name` varchar(93) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `cq_pk_item` (
  ...
  `hunter_name` varchar(45) NOT NULL DEFAULT '',
...
CREATE TABLE `cq_portal` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `mapid` (`mapid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=629 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_process_goal` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `task_num` smallint(5) unsigned NOT NULL,
  `open_lv` int(10) unsigned NOT NULL,
  `itemtype1` int(10) unsigned NOT NULL,
  `number1` smallint(5) unsigned NOT NULL,
  `monoply1` tinyint(3) unsigned NOT NULL,
  `itemtype2` int(10) unsigned NOT NULL,
  `number2` smallint(5) unsigned NOT NULL,
  `monoply2` tinyint(3) unsigned NOT NULL,
  `itemtype3` int(10) unsigned NOT NULL,
  `number3` smallint(5) unsigned NOT NULL,
  `monoply3` tinyint(3) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_process_task` (
  ...
  `monoply` tinyint(3) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_quiz` (
  ...
  `question` varchar(765) DEFAULT NULL,
...
CREATE TABLE `cq_region` (
  ...
  `bound_cx` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
  `bound_cy` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
  `datastr` varchar(45) NOT NULL DEFAULT '',
  `data0` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
  `data1` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
  `data2` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
  `data3` int(4) unsigned zerofill NOT NULL DEFAULT 0000,
...
CREATE TABLE `cq_rule` (
  ...
  `condition` varchar(765) NOT NULL DEFAULT '',
  `result` varchar(765) NOT NULL DEFAULT '',
...
CREATE TABLE `cq_synattr` (
  ...
  `duty_time_limit` int(10) unsigned DEFAULT NULL,
  `join_date` int(10) unsigned DEFAULT NULL,
  `last_logout` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `cq_syndicate` (
  ...
  `name` varchar(35) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  ...
  `leader_name` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  ...
  `member_title` tinyint(4) NOT NULL DEFAULT 0,
  `fealty_syn` int(10) unsigned DEFAULT 0,
  `enemy0` int(10) unsigned DEFAULT 0,
  `enemy1` int(10) unsigned DEFAULT 0,
  `enemy2` int(10) unsigned DEFAULT 0,
  `enemy3` int(10) unsigned DEFAULT 0,
  `enemy4` int(10) unsigned DEFAULT 0,
  `enemy5` int(10) unsigned DEFAULT 0,
  `enemy6` int(10) unsigned DEFAULT 0,
  `enemy7` int(10) unsigned DEFAULT 0,
  `enemy8` int(10) unsigned DEFAULT 0,
  `enemy9` int(10) unsigned DEFAULT 0,
  `enemy10` int(10) unsigned DEFAULT 0,
  `enemy11` int(10) unsigned DEFAULT 0,
  `enemy12` int(10) unsigned DEFAULT 0,
  `enemy13` int(10) unsigned DEFAULT 0,
  `enemy14` int(10) unsigned DEFAULT 0,
  `ally0` int(10) unsigned DEFAULT 0,
  `ally1` int(10) unsigned DEFAULT 0,
  `ally2` int(10) unsigned DEFAULT 0,
  `ally3` int(10) unsigned DEFAULT 0,
  `ally4` int(10) unsigned DEFAULT 0,
  `ally5` int(10) unsigned DEFAULT 0,
  `ally6` int(10) unsigned DEFAULT 0,
  `ally7` int(10) unsigned DEFAULT 0,
  `ally8` int(10) unsigned DEFAULT 0,
  `ally9` int(10) unsigned DEFAULT 0,
  `ally10` int(10) unsigned DEFAULT 0,
  `ally11` int(10) unsigned DEFAULT 0,
  `ally12` int(10) unsigned DEFAULT 0,
  `ally13` int(10) unsigned DEFAULT 0,
  `ally14` int(10) unsigned DEFAULT 0,
  `Publish_time` int(10) unsigned DEFAULT 0,
  `copper` int(10) unsigned DEFAULT 0,
  `iron` int(10) unsigned DEFAULT 0,
  `silver` int(10) unsigned DEFAULT 0,
  `gold` int(10) unsigned DEFAULT 0,
  `mulberry_wood` int(10) unsigned DEFAULT 0,
  `oak_wood` int(10) unsigned DEFAULT 0,
  `pear_wood` int(10) unsigned DEFAULT 0,
  `league_id` int(10) unsigned DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `name` (`name`) USING BTREE,
  KEY `index_money` (`money`) USING BTREE,
  KEY `index_aniybt` (`amount`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_traptype` (
  ...
  `name` varchar(45) NOT NULL DEFAULT 'trap',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cq_user_timeout1` (
  `name` varchar(45) NOT NULL DEFAULT '',
  `mate` varchar(45) NOT NULL DEFAULT 'None',
  `lookface` int(4) unsigned NOT NULL DEFAULT 0,
  `hair` smallint(2) unsigned NOT NULL DEFAULT 0,
  `money` int(4) unsigned NOT NULL DEFAULT 0,
  `money_saved` int(4) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `cq_viptranspoint` (
  ...
  `point_name` varchar(105) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `cq_wanted` (
  `id` int(4) unsigned NOT NULL AUTO_INCREMENT,
  `target_name` varchar(48) DEFAULT NULL,
...
CREATE TABLE `family` (
  ...
  `create_date` int(10) unsigned NOT NULL DEFAULT current_timestamp(),
  `create_name` varchar(45) DEFAULT '0',
  ...
  `del_flag` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `flower` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_player_id` (`player_id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=85 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `login_rcd` (
  ...
  `mac_adr` varchar(36) NOT NULL DEFAULT '',
  `ip_adr` varchar(45) NOT NULL DEFAULT '""',
...
CREATE TABLE `winsyndicate` (
  ...
  `SyndicateName` varchar(150) DEFAULT NULL,
  `LeaderID` int(11) DEFAULT NULL,
  `LeaderName` varchar(150) DEFAULT NULL,
...
-- Dump completed on 2024-02-17 16:41:15
